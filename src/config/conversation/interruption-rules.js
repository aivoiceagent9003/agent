...
//
// The TRANSPORT side of barge-in is already handled and is not touched here: the
// engine cancels the reply in progress and sends a clear frame so the telephony
// provider flushes audio already queued at the caller's ear (see interrupt() in
// cascade.js). That machinery works.
//
