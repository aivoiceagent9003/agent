// /work/leads/:id — the lead an employee actually works.
//
// Two columns: what the AI captured on the left (read-only — it is a record of a
// call that happened), and everything the human does on the right (status,
// assignment, notes, actions, discussion). That split is deliberate: nothing on
// the left can be edited, so there is never a question of whether you are looking
// at what the caller said or what a colleague typed.
